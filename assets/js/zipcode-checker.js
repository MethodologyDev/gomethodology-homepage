document.addEventListener('DOMContentLoaded', function () {
  ...
  if (checkButton) {
    checkButton.addEventListener('click', function (e) {
      ...
      if (zipCode) {
        checkAvailability(zipCode, resultDiv);
      } else {
...
document.addEventListener('DOMContentLoaded', function () {
  const zipInput = document.querySelector('.zip-code-input-desktop');
  const checkButton = document.querySelector('.check-avail-btn-desktop');
  const resultDiv = document.querySelector('.zip-code-desktop');
...
function checkAvailability(zipCode, resultDiv) {
